...
def evaluate_codes(model, dataset, loss_fn, output_size, historical=None):
    ...
    for step in range(len(dataset)):
        code_x, visit_lens, divided, y, neighbors, medicine_codes = dataset[step]
        output = model(code_x, divided, neighbors, visit_lens, medicine_codes)
    ...
    return avg_loss, f1_score, recall
